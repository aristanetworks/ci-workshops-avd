...
| ------------------| ----------- | ------------ | ------------ | ------------- | ----------------- | ------------------ |
| s1-brdr1 | 55 | 48 | 3 | 4 | Logging, System | Hardware |
| s1-brdr2 | 55 | 48 | 3 | 4 | Logging, System | Hardware |
| s1-leaf1 | 56 | 49 | 3 | 4 | Logging, System | Hardware |
| s1-leaf2 | 56 | 49 | 3 | 4 | Logging, System | Hardware |
| s1-leaf3 | 56 | 49 | 3 | 4 | Logging, System | Hardware |
| s1-leaf4 | 56 | 49 | 3 | 4 | Logging, System | Hardware |
| s1-spine1 | 43 | 34 | 5 | 4 | Logging, System | Hardware |
| s1-spine2 | 43 | 34 | 5 | 4 | Logging, System | Hardware |
...
| -- | ----------------- | ---------- | ---- | ----------- | ------ | -------| -------- |
| 39 | s1-brdr1 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 40 | s1-brdr1 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
...
| 94 | s1-brdr2 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 95 | s1-brdr2 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
...
| 150 | s1-leaf1 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 151 | s1-leaf1 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
...
| 206 | s1-leaf2 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 207 | s1-leaf2 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
...
| 262 | s1-leaf3 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 263 | s1-leaf3 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
...
| 318 | s1-leaf4 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 319 | s1-leaf4 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
...
| 370 | s1-spine1 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 371 | s1-spine1 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
| 373 | s1-spine1 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | FAIL | Device has reported a high CPU utilization: 100.0% |
| 375 | s1-spine1 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | FAIL | Device has reported a high memory usage: 94.98% |
...
| 413 | s1-spine2 | Logging | VerifyLoggingHosts | Verifies logging hosts (syslog servers) for a specified VRF. | - | FAIL | Syslog servers ['10.100.100.100'] are not configured in VRF default |
| 414 | s1-spine2 | Logging | VerifyLoggingSourceIntf | Verifies logging source-interface for a specified VRF. | - | FAIL | Source-interface 'Management0' is not configured in VRF default |
| 416 | s1-spine2 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | FAIL | Device has reported a high CPU utilization: 100.0% |
| 418 | s1-spine2 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | FAIL | Device has reported a high memory usage: 93.75% |
...
| 373 | s1-spine1 | System | VerifyCPUUtilization | Verifies whether the CPU utilization is below 75%. | - | FAIL | Device has reported a high CPU utilization: 100.0% |
| 374 | s1-spine1 | System | VerifyFileSystemUtilization | Verifies that no partition is utilizing more than 75% of its disk space. | - | PASS | - |
| 375 | s1-spine1 | System | VerifyMemoryUtilization | Verifies whether the memory utilization is below 75%. | - | FAIL | Device has reported a high memory usage: 94.98% |
...
| 404 | s1-spine2 | Hardware | VerifyTemperature | Verifies if the device temperature is within acceptable limits. | - | SKIPPED | VerifyTemperature test is not supported on cEOSLab. |
